...
clean_bat = function(web_link, ind, photo_link) 
{
  ...
  if(p_type == "Allrounder" | p_type == "Batting Allrounder")
  {
  #Call Python function here, that generated the RData file. 
  system(paste("conda run -n Webscrape python Syn_Scrape_ball.py", web_link, ind))
...
BALLERS = data_gen(ballers)

save(BALLERS, file = "../Ballers.RData")